...
/***/ "./node_modules/daemonite-material-additions/index.js":
/*!************************************************************!*\
  !*** ./node_modules/daemonite-material-additions/index.js ***!
  \************************************************************/
/*! no static exports found */
...
exports.Element = exports.Snackbar = undefined;

var _Snackbar = __webpack_require__(/*! ./src/Snackbar */ "./node_modules/daemonite-material-additions/src/Snackbar.js");

var _Snackbar2 = _interopRequireDefault(_Snackbar);

var _Element = __webpack_require__(/*! ./src/Inc/Element */ "./node_modules/daemonite-material-additions/src/Inc/Element.js");
...
/***/ "./node_modules/daemonite-material-additions/src/Inc/Element.js":
/*!**********************************************************************!*\
  !*** ./node_modules/daemonite-material-additions/src/Inc/Element.js ***!
  \**********************************************************************/
/*! no static exports found */
...
var Element = function () {
     ...
     * @returns {Element}
     */
    function Element(tagName, innerHTML, attributes) {
    ...
    _createClass(Element, [{
        ...
        value: function appendTo(selector) {
            ...
            nodeList.foreach(function (node) {
                return node.appendChild(_this.el);
            });
        ...
        value: function prependTo(selector) {
            ...
            if (selector instanceof Element) {
                ...
                var nodeList = document.querySelectorAll(selector);
                nodeList.foreach(function (node) {
                    return node.insertBefore(_this2.el, node.firstChild);
                });
            }
        ...
        value: function addClass(className) {
            ...
            className.forEach(function (cls) {
                return _this3.el.classList.add(cls);
            });
        ...
        value: function removeClass(className) {
            ...
            // Loop through the classNames and add them to the element
            className.forEach(function (cls) {
                return _this4.el.classList.remove(cls);
            });
...
/***/ "./node_modules/daemonite-material-additions/src/Snackbar.js":
/*!*******************************************************************!*\
  !*** ./node_modules/daemonite-material-additions/src/Snackbar.js ***!
  \*******************************************************************/
/*! no static exports found */
...
var _Element = __webpack_require__(/*! ./Inc/Element */ "./node_modules/daemonite-material-additions/src/Inc/Element.js");
...
var Snackbar = function () {
        ...
        _createClass(Snackbar, null, [{
                 ...
                 * @param settings_
                 */
                value: function render(settings_) {
                        ...
                        // Generate the div
                        var snackbar = this.generateSnackbarComponent(settings);
                ...
                key: 'generateSnackbarComponent',
                value: function generateSnackbarComponent(settings) {

                        var snackbar = new _Element2.default('div', null, { class: 'snackbar' });
                        var snackbarBody = new _Element2.default('div', settings.html, { class: 'snackbar-body' });
...
/***/ "./node_modules/stein/lib/stein.js":
/*!*****************************************!*\
  !*** ./node_modules/stein/lib/stein.js ***!
  \*****************************************/
/*! no static exports found */
...
/* harmony import */ var _Style_app_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Style/app.scss */ "./src/assets/Style/app.scss");
...
/* harmony import */ var _Lib_AppModule__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Lib/AppModule */ "./src/assets/Lib/AppModule.js");
/* harmony import */ var daemonite_material_additions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! daemonite-material-additions */ "./node_modules/daemonite-material-additions/index.js");
/* harmony import */ var daemonite_material_additions__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(daemonite_material_additions__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _Lib_Log__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../Lib/Log */ "./src/assets/Lib/Log.js");
/* harmony import */ var _Lib_Favicon__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../Lib/Favicon */ "./src/assets/Lib/Favicon.js");
/* harmony import */ var _Images_purple_favicon_png__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../Images/purple-favicon.png */ "./src/assets/Images/purple-favicon.png");
/* harmony import */ var _Images_purple_favicon_png__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_Images_purple_favicon_png__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _Images_red_favicon_png__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../Images/red-favicon.png */ "./src/assets/Images/red-favicon.png");
/* harmony import */ var _Images_red_favicon_png__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_Images_red_favicon_png__WEBPACK_IMPORTED_MODULE_7__);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var BuilboFrontend = function (_AppModule) {
    _inherits(BuilboFrontend, _AppModule);

    /**
     *
     */
    function BuilboFrontend() {
        _classCallCheck(this, BuilboFrontend);

        var _this = _possibleConstructorReturn(this, (BuilboFrontend.__proto__ || Object.getPrototypeOf(BuilboFrontend)).call(this));

        _this.socket = socket_io_client__WEBPACK_IMPORTED_MODULE_0___default.a.connect(window.location.origin);
        _this.active_builder_id = null;
        _this.attached_logs = [];

        // Socket events
        _this.socket.on('builder-details', function (data) {
            _this.builderDetails(data);
        });

        _this.socket.on('builder-activated', function (data) {
            _this.attachLog();
            _this.builderIsActivated(data.builder_id);
        });

        _this.socket.on('builder-deactivated', function (data) {
            _this.builderIsDeactivated(data.builder_id);
            _this.Favicon.blink(_Images_red_favicon_png__WEBPACK_IMPORTED_MODULE_7___default.a, 2000);
        });

        _this.socket.on('builder-log-line', function (data) {
            if (data.builder_id === _this.active_builder_id || 'flush' in data && data.flush) {
                _this.Log.appendLine(data.logLine);
                _this.Favicon.blink(_Images_purple_favicon_png__WEBPACK_IMPORTED_MODULE_6___default.a, 1500);
            }
        });

        _this.socket.on('builder-error', function (data) {
            _this.builderError(data.message);
        });
    ...
    _createClass(BuilboFrontend, [{
        key: 'DOMReady',
        value: function DOMReady() {
            // Initialize the LogInterface
            this.Log = new _Lib_Log__WEBPACK_IMPORTED_MODULE_4__["default"]();

            // Initialize the Favicon changer
            this.Favicon = new _Lib_Favicon__WEBPACK_IMPORTED_MODULE_5__["default"]();

            var self = this;

            // Bind the builder selectors
            var allBuilderSelectors = document.querySelectorAll('[data-select-builder]');
            allBuilderSelectors.forEach(function (builderSelectorDiv) {
        ...
        key: 'builderDetails',
        value: function builderDetails(data) {
            ...
            var builderContainer = document.getElementById('builderContainer');
        ...
        key: 'activateBuilder',
        value: function activateBuilder(builder_id) {
        ...
        key: 'deactivateBuilder',
        value: function deactivateBuilder(builder_id) {
        ...
        key: 'builderIsDeactivated',
        value: function builderIsDeactivated(builder_id) {
            this.attached_logs.splice(this.attached_logs.indexOf(builder_id), 1);

            var builderSelector = document.getElementById('builderSelector' + builder_id);
            if (builderSelector) {
                builderSelector.classList.remove('active');
            }

            var builderSwitcher = document.getElementById('builderSwitch' + builder_id);
            if (builderSwitcher) {
        ...
        key: 'builderIsActivated',
        value: function builderIsActivated(builder_id) {
        ...
        key: 'builderError',
        value: function builderError(message) {
            daemonite_material_additions__WEBPACK_IMPORTED_MODULE_3__["Snackbar"].render({
                html: message
            });
        }
    }]);

    return BuilboFrontend;
}(_Lib_AppModule__WEBPACK_IMPORTED_MODULE_2__["AppModule"]);

new BuilboFrontend();

/***/ }),

/***/ "./src/assets/Images/purple-favicon.png":
/*!**********************************************!*\
  !*** ./src/assets/Images/purple-favicon.png ***!
  \**********************************************/
/*! no static exports found */
...
module.exports = "/dist/purple-favicon.png";

/***/ }),

/***/ "./src/assets/Images/red-favicon.png":
/*!*******************************************!*\
  !*** ./src/assets/Images/red-favicon.png ***!
  \*******************************************/
/*! no static exports found */
...
module.exports = "/dist/red-favicon.png";

/***/ }),

/***/ "./src/assets/Lib/AppModule.js":
/*!*************************************!*\
  !*** ./src/assets/Lib/AppModule.js ***!
  \*************************************/
...
/* harmony import */ var stein__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! stein */ "./node_modules/stein/lib/stein.js");
/* harmony import */ var stein__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(stein__WEBPACK_IMPORTED_MODULE_0__);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var AppModule = function (_DefaultModule) {
    ...
    return AppModule;
}(stein__WEBPACK_IMPORTED_MODULE_0__["DefaultModule"]);

/***/ }),

/***/ "./src/assets/Lib/Favicon.js":
/*!***********************************!*\
  !*** ./src/assets/Lib/Favicon.js ***!
  \***********************************/
...
var Favicon = function () {
    ...
    _createClass(Favicon, [{
        ...
        key: 'blink',
        value: function blink(icon, time) {
            var self = this;
            debounce__WEBPACK_IMPORTED_MODULE_0___default()(function () {
                time = time || 1000;
                self.change(icon);
                if (self.resetQueue !== false) {
                    clearTimeout(self.resetQueue);
                }
                self.resetQueue = setTimeout(function () {
                    self.reset();
                }, time);
            }, 100)();
        }
        ...
        key: '_iconLoop',
        value: function _iconLoop(fn) {
            for (var i = 0; i < this.iconEls.length; i++) {
                fn(this.iconEls[i]);
            }
        }
    }]);
...
var LogInterface = function () {
    ...
    function LogInterface() {
        _classCallCheck(this, LogInterface);
    ...
    _createClass(LogInterface, [{
        ...
        key: '_cleanLine',
        value: function _cleanLine(line) {
            return line.trim();
        }
    }]);
...
/* harmony default export */ __webpack_exports__["default"] = (LogInterface);
...
throw new Error("Module build failed (from ./node_modules/mini-css-extract-plugin/dist/loader.js):\nModuleBuildError: Module build failed (from ./node_modules/sass-loader/lib/loader.js):\n\n@import '~daemonite-material/assets/scss/material.scss';\n^\n      File to import not found or unreadable: ~daemonite-material/assets/scss/material.scss.\n      in /mnt/data/Node projects/builbo/src/assets/Style/app.scss (line 1, column 1)\n    at runLoaders (/mnt/data/Node projects/builbo/node_modules/webpack/lib/NormalModule.js:303:20)\n    at /mnt/data/Node projects/builbo/node_modules/loader-runner/lib/LoaderRunner.js:364:11\n    at /mnt/data/Node projects/builbo/node_modules/loader-runner/lib/LoaderRunner.js:230:18\n    at context.callback (/mnt/data/Node projects/builbo/node_modules/loader-runner/lib/LoaderRunner.js:111:13)\n    at Object.asyncSassJobQueue.push [as callback] (/mnt/data/Node projects/builbo/node_modules/sass-loader/lib/loader.js:67:13)\n    at Object.done [as callback] (/mnt/data/Node projects/builbo/node_modules/neo-async/async.js:7974:18)\n    at options.error (/mnt/data/Node projects/builbo/node_modules/node-sass/lib/index.js:294:32)");
...
},[["./src/assets/Entry/app.js","commons"]]]);
