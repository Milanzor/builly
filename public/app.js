...
var BuillyFrontend = function (_AppModule) {
    _inherits(BuillyFrontend, _AppModule);

    /**
     *
     */
    function BuillyFrontend() {
        _classCallCheck(this, BuillyFrontend);

        var _this = _possibleConstructorReturn(this, (BuillyFrontend.__proto__ || Object.getPrototypeOf(BuillyFrontend)).call(this));
        ...
        _this.socket.on('builder-deactivated', function (data) {
            ...
            if (_this.active_builder_id === data.builder_id) {
        ...
        _this.socket.on('builder-log-line', function (data) {
            var flush = 'flush' in data && data.flush;
            if (data.builder_id === _this.active_builder_id || flush) {
...
module.exports = "/purple-favicon.png";
...
module.exports = "/red-favicon.png";
